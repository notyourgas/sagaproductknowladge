# Other Project Registry

Project di bawah ini tetap dicatat agar ChatGPT mengetahui keberadaannya, tetapi
tidak boleh dianggap produk aktif tanpa evidence baru.

| Project | Kind | Status | Catatan |
|---|---|---|---|
...
| SagaDev Website | Marketing surface | BUILD/REPLACE | Showroom produk, bukan operational control plane |
| Madiun Classic Jersey | Client project | PROTOTYPE | Registry/deployment tracking saja |
| Neo Group | Client project | PROTOTYPE | Registry/deployment tracking saja |
