...
| GAP-014 | SagaBook | TODO | Edit pembayaran, upload/histori bukti pembayaran, serta override jadwal OTS Manual Booking sudah production-activated, tetapi authenticated Owner/operator UAT belum dijalankan pada booking manual nyata. | Siapkan akun referensi UAT tanpa mengekspos credential; uji custom time, conflict override, payment-hold hard block, badge/history/report, upload, viewer, replacement, late evidence, dan no-financial-mutation pada exact source `0dda935...` / release `20260824141906-0dda935`; lanjutkan dua studio pilot sebelum `BUSINESS_READY`. |
