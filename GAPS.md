...
| GAP-015 | SagaWork | NEEDS CONFIRMATION | Exact `e59efcd` aktif sebagai public synthetic trial di `app.sagawork.site`; domain feature `5921f43`, acceptance `c3c5e5f`. Full gate 38/138, 47-page build, 66/24/32 data contract, OpenAPI 70/85/48, TLS/security headers/Secure public cookie, eight HR pages 200, wrong password 401, manifest 1.084, dan rollback PASS. Satu restricted allowlisted HR trial identity siap feature review tanpa TOTP; tidak ada real Staff/photo/GPS dan akun ini tidak boleh menjadi akun pilot. Password trial lemah wajib dirotasi/dihapus, photo object workflow belum public-ready, shared-host `/tmp` hampir penuh, serta protected pilot access/dedicated database/provider/offsite recovery/signed admission/human UAT belum lulus. K0/K1 tetap NO-GO. | Andreas menjalankan feature review dengan data sintetis dan membekukan revisi; jangan masukkan data Kananta nyata. Secara terpisah, rotasi/hapus akun trial, siapkan protected pilot access, dedicated pilot database/secret scope, private provider/offsite backup, host-capacity remediation, dan signed admission; kemudian buat akun HR pilot baru dengan email/token/password/TOTP baru. Lanjutkan roster/champion, 19 ASVS external/risk dispositions, hosted CI/legal/device/incident/parallel evidence, signed receipt, dan activation window. |
