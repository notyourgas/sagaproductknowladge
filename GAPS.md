...
| GAP-015 | SagaWork | NEEDS CONFIRMATION | Synthetic staging kini mencakup atomic CSV import, paid/unpaid break, default-off unscheduled reconciliation, supervisor-assisted attendance, dan private non-PII photo-byte pipeline pada same-VPS loopback store; internal disposition `PILOT_READY_CANDIDATE`, tetapi business readiness tetap false karena external provider/DPA/browser endpoint, offsite key escrow, legal/privacy, real-device GPS/camera UAT, alert/incident rehearsal, pricing/WTP, named pilot, public route, dan final activation belum lulus. Training/test isolation serta multi-session policy juga belum lengkap. | External provider non-PII spike + DPA/key/quota/failure evidence, recovery/key approval, legal sign-off, device/human UAT, named pilot evidence, lalu final Go/No-Go Andreas; XLSX, employer-ordered/holiday OT, training/test isolation, dan multi-session diputuskan sesuai kebutuhan pilot. |
