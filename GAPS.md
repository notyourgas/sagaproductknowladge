...
| GAP-005 | COYABAG | NEEDS CONFIRMATION | Katalog final, identitas seller legal/pajak, UAT transaksi, dan sign-off masih belum dikunci. Baseline privacy/retention versi `2026.08-v1` sudah dikonfigurasi dan draft delapan bagian tersedia, tetapi belum disetujui atau dipublikasikan owner. | Owner 2FA, review/publish/approval policy, data legal final, UAT 15 langkah, dan release sign-off. |
...
| GAP-007 | Semua produk | NEEDS CONFIRMATION | COYABAG sudah memiliki baseline retention report-only versi `2026.08-v1`, tetapi approval owner dan policy publik belum selesai; produk lain masih membutuhkan policy, deletion SLA, incident contact, dan subprocessor list masing-masing. | Policy per produk, owner, tanggal berlaku, approval, dan bukti publikasi. |
