...
| GAP-015 | SagaWork | NEEDS CONFIRMATION | Exact `e59efcd` aktif sebagai public synthetic trial di `app.sagawork.site`. Workspace core exact source `e2a0391` sudah `LOCAL_VALIDATED / IMPLEMENTED_NOT_DEPLOYED`: 67 tabel/26 migration, OpenAPI 76/95/52, 41 file/150 test, dan 49-page build. Effective-dated assignment, scoped HR context, GPS setup preview, shift template dan schedule eligibility ada, tetapi migrations `0024`/`0025` belum runtime. F19 rest-day exchange khusus, roster automation, employer-ordered overtime, generalized notification/outbox, XLSX, rights workflow, external provider/legal/device/offsite/independent review/signed admission dan owner/canary UAT masih terbuka. Tidak ada real Staff/photo/GPS dan akun trial tidak boleh menjadi akun pilot. Password trial lemah, photo workflow publik, shared-host capacity, K0/K1 tetap blocker. | Rilis exact source ke synthetic trial melalui backup/migrate/smoke/rollback, lalu jalankan owner rehearsal. Jangan masukkan data Kananta sebelum F37-F44 lengkap dan signed admission PASS. Tutup backlog F19 dan partial F09/F10/F12/F14/F15/F17/F27/F32/F34-F40, rotasi/hapus akun trial, siapkan protected pilot access/dedicated DB/private provider/offsite backup/hosted CI/legal/device/incident evidence, lalu F49-F52 canary. |
