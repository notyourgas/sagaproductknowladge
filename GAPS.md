...
| GAP-015 | SagaWork | NEEDS CONFIRMATION | Exact handoff runtime `8f503f9` dan protected Preview `dpl_HoQQLSG3nTMJAPnK17Ut1v9eMjm6` telah melewati 33/111 test, 44-page build, 20-area smoke, 9/9 abuse, workstation-to-loopback browser/Axe 12/4, load 720/720, manifest 1.049 file, restore, dan rollback pada identical application bits `05e2b1a`. Role-performance default-off lulus synthetic authorization/evidence/appeal/no-automation guardrails tetapi belum mempunyai company KPI/source adapters, legal/transparency, calibration/fairness, atau human validation. ASVS profile tetap 155 pass internal, 79 N/A, 0 pending internal, 18 pending external, dan 1 Staff no-OTP risk acceptance; ini bukan certification/full-Level-2. Fail-closed admission mengikat 16 Gate A/B/C/E evidence tetapi belum ada real receipt. Business readiness tetap false karena private source remote/hosted CI, capacity monitoring, independent security verification, external provider/DPA/browser endpoint, offsite key escrow, legal/privacy, real-device UAT, alert/incident rehearsal, pricing/WTP, named pilot, public route, receipt, canary, dan final activation belum lulus. XLSX/async private export, dedicated coverage/leave/exception report, rehire/offboarding authority, scheduled/backdated termination, serta training/test isolation juga belum lengkap. | Selesaikan atau terima 19 external/risk-acceptance ASVS disposition; provision private source remote + protected hosted CI; lakukan capacity/soak monitoring, independent security review, provider non-PII spike + DPA/key/quota/failure evidence, offsite recovery/key approval, legal sign-off, device/human UAT, dan workshop KPI/source/rubric/transparency/calibration/fairness. Tetapkan named pilot/public route/incident rehearsal, lengkapi seluruh 16 restricted evidence, lalu Andreas menandatangani exact-target receipt sebelum activation change window. |
| GAP-016 | SagaView | NEEDS CONFIRMATION | Akar cached staging path dan concurrency publication window S288 sudah ditutup pada exact pushed `51250078...`. Full/focused/build/security dan Linux disposable lulus; production tetap utuh, tetapi target rollback masih hilang dan approval recovery sebelumnya sudah habis. | Minta approval eksplisit baru khusus recovery inactive. Setelah rollback target pulih dan runtime evidence lulus, ulang S287 preflight; deploy kandidat tetap approval terpisah. |
| GAP-017 | Snap and Fit | NEEDS CONFIRMATION | Encrypted event-scoped face search dan official liveness client sudah `LOCAL_VALIDATED`; exact transitive React peer metadata gate sudah ditutup dengan narrow rule dan full local evidence. Isolated provider runtime, legal notice approval, real-device UAT, deletion evidence, dan threshold benchmark belum terbukti. | Sediakan isolated AWS/Cognito/S3/MySQL/Redis test environment, approved legal notice, dan perangkat UAT; recheck upstream package, lalu jalankan benchmark, privacy deletion, failure/lockout, serta Go/No-Go terpisah sebelum activation. |
