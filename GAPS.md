...
| GAP-015 | SagaWork | NEEDS CONFIRMATION | Exact `e59efcd` aktif sebagai public synthetic trial di `app.sagawork.site`; domain feature `5921f43`, acceptance `c3c5e5f`. Full gate 38/138, 47-page build, 66/24/32 data contract, OpenAPI 70/85/48, TLS/security headers/Secure public cookie, eight HR pages 200, wrong password 401, manifest 1.084, dan rollback PASS. Workspace/Cabang model serta F01-F60 plan exact `79179d9` sudah CONFIRMED tetapi belum diimplementasikan. Tidak ada real Staff/photo/GPS dan akun trial tidak boleh menjadi akun pilot. Password trial lemah wajib dirotasi/dihapus, photo object workflow belum public-ready, shared-host `/tmp` hampir penuh, serta protected pilot access/dedicated database/provider/offsite recovery/signed admission/human UAT belum lulus. K0/K1 tetap NO-GO. | Mulai F01 Workspace contract lalu selesaikan F01-F44 sebelum owner rehearsal F45-F48; jangan masukkan data Kananta nyata. Setelah owner acceptance, jalankan F49-F52 five-Staff canary. Rotasi/hapus akun trial, siapkan protected pilot access, dedicated pilot database/secret scope, private provider/offsite backup, host-capacity remediation, 19 ASVS external/risk dispositions, hosted CI/legal/device/incident/parallel evidence, signed receipt, dan activation window. |
