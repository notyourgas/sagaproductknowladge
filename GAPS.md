...
| GAP-015 | SagaWork | NEEDS CONFIRMATION | Synthetic staging kini mencakup atomic CSV import, paid/unpaid break, default-off unscheduled reconciliation, handoff, dan internal `PILOT_READY_CANDIDATE`; business readiness tetap false karena real storage/scanner, offsite key escrow, legal/DPA, real-device GPS/camera UAT, alert/incident rehearsal, pricing/WTP, named pilot, public route, dan final activation belum lulus. | Provider non-PII spike, recovery/key approval, legal sign-off, device/human UAT, named pilot evidence, lalu final Go/No-Go Andreas; XLSX dan employer-ordered/holiday OT diputuskan sesuai kebutuhan pilot. |
