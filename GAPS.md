...
| GAP-015 | SagaWork | NEEDS CONFIRMATION | Synthetic staging kini mencakup atomic CSV import, paid/unpaid break, default-off unscheduled reconciliation, dan private non-PII photo-byte pipeline pada same-VPS loopback store; internal disposition `PILOT_READY_CANDIDATE`, tetapi business readiness tetap false karena external provider/DPA/browser endpoint, offsite key escrow, legal/privacy, real-device GPS/camera UAT, alert/incident rehearsal, pricing/WTP, named pilot, public route, dan final activation belum lulus. | External provider non-PII spike + DPA/key/quota/failure evidence, recovery/key approval, legal sign-off, device/human UAT, named pilot evidence, lalu final Go/No-Go Andreas; XLSX dan employer-ordered/holiday OT diputuskan sesuai kebutuhan pilot. |
| GAP-016 | SagaView | NEEDS CONFIRMATION | Akar kegagalan S288 sudah ditutup pada exact pushed repair `04e3b218...`: cache Laravel menyimpan 15 referensi absolut staging dan kini dibangun ulang di path final. Full/focused/build/security serta disposable relocation gate lulus; production tetap utuh, tetapi target rollback masih hilang dan approval recovery sebelumnya sudah habis. | Lakukan readiness review exact repair, lalu minta approval eksplisit baru khusus recovery inactive. Setelah rollback target pulih dan runtime evidence lulus, ulang S287 preflight; deploy kandidat tetap approval terpisah. |
