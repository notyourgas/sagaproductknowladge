...
| GAP-015 | SagaWork | NEEDS CONFIRMATION | Exact `c14f5c2` aktif pada synthetic staging; feature `eb3b372`, acceptance `0cd3516`. Full gate 38/137, 47-page build, 66/24/32 data contract, OpenAPI 70/85/48, eight HR pages 200, wrong password 401, encrypted backup, manifest 1.084, dan rollback PASS. Satu restricted allowlisted HR trial identity siap feature review tanpa TOTP hanya pada loopback staging sintetis; tidak ada real Staff/photo/GPS dan akun ini tidak boleh menjadi akun pilot. Shared-host `/tmp` hampir penuh; protected pilot TLS, dedicated database, provider/offsite recovery, signed admission, serta human UAT belum lulus. K0/K1 tetap NO-GO. | Andreas menjalankan feature review dengan akun trial dan membekukan revisi. Secara terpisah, siapkan protected TLS, dedicated pilot database/secret scope, private provider/offsite backup, host-capacity remediation, dan signed admission; kemudian buat akun HR pilot baru dengan email/token/password/TOTP baru. Lanjutkan roster/champion, 19 ASVS external/risk dispositions, hosted CI/legal/device/incident/parallel evidence, signed receipt, dan activation window. |
