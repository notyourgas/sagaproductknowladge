...
| GAP-015 | SagaWork | NEEDS CONFIRMATION | Synthetic staging dan atomic CSV staff import tervalidasi, tetapi XLSX/error export, real storage/scanner, offsite key escrow, legal/DPA, real-device GPS/camera UAT, alert/incident rehearsal, pricing/WTP, named pilot, dan final activation belum lulus. | XLSX/error export bila dibutuhkan pilot, provider non-PII spike, recovery/key approval, legal sign-off, device/human UAT, pilot evidence, lalu final Go/No-Go Andreas. |
