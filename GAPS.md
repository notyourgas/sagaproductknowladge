...
| GAP-018 | Saga Member Platform | NEEDS CONFIRMATION | DEC-138 dan release `20260902T1526Z-f763fc1-2eaa353` menutup blocker deployment D0: runtime/database terisolasi, forced RLS, monitor, backup/restore, rollback dan remote UAT lulus. Aktivasi R0 tetap tertutup karena exact domain, DNS/TLS, Resend production, hashed internal allowlist dan expiring passport belum tersedia. Snapshot bridge hanya diterima untuk internal alpha; swap shared host juga perlu dipantau. | Pilih exact domain, konfigurasi DNS/TLS dan Resend melalui channel restricted, buat hashed allowlist serta expiring passport, lalu ulangi remote UAT/monitor/rollback sebelum mengubah state menjadi activated. Jangan aktifkan public, Gateway/QRIS, Push, SagaBook live, NFC, printer, outlet kedua, commercial tenant atau R3-R6. |
