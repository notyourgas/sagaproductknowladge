...
| GAP-005 | COYABAG | DEPRECATED | Gate lama ditutup 8 September 2026: readiness 45/45, owner 2FA, UAT/sign-off, provider health, dan exception high/critical terbuka nol; checkout publik aktif tanpa owner kedua. Status siap order berlaku pada scope payment gateway dan shipping manual, bukan coverage nasional otomatis. | Pantau provider/exception, tampilkan cakupan kirim secara jujur, dan lanjutkan offsite-backup serta CSP sebagai hardening. |
...
| GAP-018 | Saga Member Platform | NEEDS CONFIRMATION | CONFIRMED: R0 domain asli dan authoritative API/PostgreSQL telah PRODUCTION_DEPLOYED dan PRODUCTION_ACTIVATED pada release `20260907T140646Z-75d56d5-r0`; batas D0 historis DEPRECATED oleh DEC-193. Owner first-use consent dan dashboard business UAT masih pending; BUSINESS_READY=false. Encrypted local backup/disposable restore/rollback PASS, independent offsite recovery belum terverifikasi. | Owner first-use consent dan business UAT; monitoring sampai 2026-09-14T14:08:12.752Z. Provider eksternal, customer lain, NFC/printer dan commercial expansion tetap OFF. |
