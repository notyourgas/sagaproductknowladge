...
| GAP-015 | SagaWork | NEEDS CONFIRMATION | Synthetic staging, atomic CSV staff import, dan paid/unpaid break policy tervalidasi, tetapi XLSX/error export, employer-ordered overtime/holiday-rest, real storage/scanner, offsite key escrow, legal/DPA, real-device GPS/camera UAT, alert/incident rehearsal, pricing/WTP, named pilot, dan final activation belum lulus. | XLSX/error export bila dibutuhkan pilot, overtime/legal policy, provider non-PII spike, recovery/key approval, legal sign-off, device/human UAT, pilot evidence, lalu final Go/No-Go Andreas. |
