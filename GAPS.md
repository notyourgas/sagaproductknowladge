...
- `CONFIRMED`: gap arbitrary historical completed count-pair selection tertutup secara lokal pada source `a0973f2dc25d29f7dee050c946564528d6bafe70`, termasuk invalid-closing prevention, selection-stable polling, exact-pair CSV, reset-to-latest dan safe server validation.
