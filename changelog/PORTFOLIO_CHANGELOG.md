...
- Finance Admin tanpa `manage_booking_status` tidak memutar nada verifikasi
  pembayaran/transfer manual; booking web berikutnya tetap berbunyi sekali
  tanpa replay saat refocus.
- Mute Owner tidak bocor ke Finance Admin pada tenant/browser yang sama;
  Finance tetap aktif dan memutar tiga nada booking, sedangkan Owner tetap mute
...
- Kondisi offline dan refocus tetap diam; setelah reconnect, booking baru
  berbunyi satu batch tiga nada dan event online/refocus tidak replay.
- Expiry sesi 419 tetap diam dan mengarah ke login; login ulang tetap senyap,
...
- Booking staged pada simulasi bfcache `pagehide` tetap diam; `pageshow` dan
  focus memutar satu batch, lalu transisi/focus berikutnya tidak replay.
- Browser 16/16 dengan 48 eksekusi viewport, focused PHP 21/21 (113 assertion), unit 9/9, typecheck/build,
