...
Evidence cut-off: 25 Agustus 2026 18:46 WIB
...
Snap and Fit exact private source head `ee45e56` berstatus `CONFIRMED /
LOCAL_VALIDATED`; immutable supply-chain hardening berasal dari `ee45e56`,
...
restore menolak non-digest MySQL override, dan validation memulai immutable
...
image build/scan/SBOM-attestation/pull/runtime tetap staging gate.
