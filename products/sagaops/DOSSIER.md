...
- `CONFIRMED`; exact source final `bd353d1a6caae390cd5c3fdf201bb85796b69263`, berdasarkan source, test dan laporan kanonik Saga POS. Tidak ada data supplier atau receipt bisnis dipublikasikan.
...
- Rumus: base quantity = package quantity x base units/package; inventory value = prior value + receipt cost; moving average = rounded inventory value/base quantity. Nilai Rupiah tetap safe integer dan kuantitas maksimal tiga desimal. Biaya tambahan, pajak, freight dan diskon tidak dialokasikan diam-diam karena kebijakan valuasinya belum disahkan.
...
- Full regression menemukan kegagalan restart dari urutan JSONB; assertion dipertahankan dan implementasi diperbaiki. Hardening lanjutan merekonsiliasi receipt dengan saldo quantity/value, biaya ingredient dan batas versi. Final: focused 29/29, regression 318/318, check 166 modul/OpenAPI 3.1/12 migrasi, browser 390x844 dan 1440x900, Axe 0 serious/critical, touch/overflow/reduced-motion PASS, audit dependency dan high-confidence secret/restricted-path scan 0.
