...
Release terbaru mempertahankan desain Warm Wood produksi dan hanya mengadopsi urutan flow dari referensi kiosk. Public UAT Vercel lulus untuk QRIS dan cash, image decode terverifikasi, serta tidak ada page error. Core exact source `451c596c913c47b87a1c623e42b27063a84c3c26` kemudian diaktifkan dengan rollback `ec77f887c40e80c58ef78df39508596a70787727` setelah Owner gate, immutable target admission, encrypted backup/disposable restore, candidate-current-candidate rehearsal, dan activation atomik lulus. Authenticated Owner smoke bertahan setelah restart; browser production menghasilkan tiket demo `KD-*` berstatus `PAID`, dan projection KDS menyatakan `NEW` serta `demo_only=true`. Status `VERCEL_PUBLIC_DEMO_DEPLOYED / PUBLIC_DEMO_ACTIVE / PRODUCTION_DEPLOYED / PRODUCTION_ACTIVATED / AUTHENTICATED_OWNER_TECHNICAL_UAT_PASS / PUBLIC_TRANSACTION_SIMULATION_PASS / BUSINESS_READY=false`; perangkat fisik, payment nyata, final content, independent offsite restore, dan business acceptance tetap gate terpisah.
