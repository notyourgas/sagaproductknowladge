...
- `CONFIRMED`; source `a0973f298f2181f5439f2b7b587d27d1f66b5e56` menambah completed opening/closing selector, selection-stable polling, exact-pair CSV, reset-to-latest serta client prevention/recovery copy untuk closing yang tidak lebih baru pada Owner Dashboard.
