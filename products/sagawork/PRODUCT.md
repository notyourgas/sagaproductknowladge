...
Belum ada real employee/photo data, public DNS, external provider storage/DPA, offsite key escrow, human device/PWA-install UAT, legal/privacy approval, named pilot, private source remote/hosted CI run, real signed admission receipt, atau closed beta. XLSX/async private export, dedicated coverage/leave/exception export, rehire, scheduled/backdated termination, real offboarding authority/SOP, training/test shift isolation, dan multi-session policy juga masih terbuka. Payroll nominal/compliance tidak diklaim. Next gate: moderated synthetic UAT, source/CI custody, external provider/recovery, GPS-camera-install field UAT, incident rehearsal, pilot/DPA, seluruh 16 evidence restricted, lalu final receipt dan Go/No-Go Andreas.
