...
Handoff source untuk exact runtime `e003a3d` kini memiliki restricted tracked-file archive yang reproducible dari Git, immutable provenance sidecar, dan SHA-256 sidecar. Artifact berukuran 1.176.243 byte dengan checksum `461efe3105ebfbebb743ade95f59ad0cb70fbcb89ebd2655d00845dd3cd7db34`; verifier memastikan tidak ada secret, runtime env, database dump, PII, dependency tree, atau build cache. File artifact restricted tidak disalin ke repository knowledge publik. Dokumentasi implementasi memetakan 56 tabel/21 migration dan 56 route file/69 operasi API; drift verifier gagal bila source table/route tidak tercantum. Ini adalah implemented contract, bukan pengganti formal OpenAPI 3.1 schemas/generated client yang masih pending.
