...
Next.js 16 PWA, React 19, TypeScript, Drizzle, MySQL 8.4, Node 22, systemd, isolated Hostinger staging, dan Vercel Preview. Active runtime `9d49565` memiliki 21 migration, 56 application table, 26 append-only trigger, dan manifest 26 artifact. 26 test file/87 unit test, smoke 17 area, security abuse 7/7, browser+Axe 12 pass/4 intentional scope skip, 720-request load, recovery, timer, dan guarded rollback `9d49565 → da2e662 → 9d49565` lulus pada synthetic staging. Protected Staff/HR layouts dipaksa dynamic sehingga build tanpa database environment tidak dapat memublikasikan workspace statis.
