...
- A separate public runtime was observed at the target hostname after this candidate was prepared: frontend source `8ce4f37d49f0eeeee51664fda0bca7e3f92c6d8e`, runtime release `20260907T140646Z-75d56d5-r0`, `PUBLIC_DUMMY_DEMO=false`, and same-origin `/v1` responses. Its exact backend release, release-lock owner, activation passport, restore receipt, authenticated UAT, monitoring, and rollback evidence were not verified; `/health` and `/ready` returned 404 during the read-only audit. Classify this as `PUBLIC_RUNTIME_OBSERVED / ACTIVATION_UNVERIFIED`, not as an accepted R0 activation.
- The local clean frontend integration `4a0dd8258017b4eb334cf65220ec8c90d9cc3181` combines V100 `be51f311ddb30e9d5e6f911ca2ca9abe35d01a0e` with the observed frontend source and remains unpushed/undeployed. Static, 467 unit, card-upgrade, five-viewport browser, account-sync, runtime and dependency gates passed; one full-suite attempt recorded a preserved CPU4x 54 ms long-task failure before the unchanged focused rerun passed, so full-suite stability is not claimed. Payment/QRIS, commerce and reward writes, marketing/mass email, Push, NFC, printer, support merge, other customers, and external transactions remain OFF; backend candidate delivery remains `SOURCE_PUSHED / LOCAL_VALIDATED / IMPLEMENTED_NOT_DEPLOYED`, `PRODUCTION_ACTIVATED=UNVERIFIED`, `BUSINESS_READY=false`.
