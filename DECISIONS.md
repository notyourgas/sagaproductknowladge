...
- Dampak: exact backend candidate `d0016572a5f03374bb5d721599717aff2f13c48a` menyiapkan fail-closed R0 dan release/recovery Hostinger, tetapi belum terbukti terpasang. Runtime publik teramati memakai frontend `8ce4f37d49f0eeeee51664fda0bca7e3f92c6d8e` / release `20260907T140646Z-75d56d5-r0`; karena exact backend, lock owner, health/readiness, passport, restore, authenticated UAT, monitoring dan rollback belum terverifikasi, observasi ini tidak mengubah keputusan menjadi activation acceptance. Local integration `4a0dd8258017b4eb334cf65220ec8c90d9cc3181` juga belum dipush/dideploy dan masih memiliki catatan CPU4x flake. Payment/QRIS, commerce/reward writes, Push, marketing/mass email, NFC/printer, support merge, other customers dan external transactions tetap OFF.
